...
public class NoteBookNoteUserInputReader {
	...
	private NoteBookNoteDTO readNoteBookNoteUserInput() {
		...
		noteDTO.setContacts(readNoteBookNoteUserContacts());
		...
		noteDTO.setAddress(readNoteBookNoteUserAddress());
		noteDTO.setGroup(readNoteBookNoteUserGroup());
		return noteDTO;
	}
	...
	private ContactsDTO readNoteBookNoteUserContacts() {
	...
	private AddressDTO readNoteBookNoteUserAddress() {
	...
	private Group readNoteBookNoteUserGroup() {
